...
public class JedisCluster implements JedisCommands, BasicCommands, Closeable
{
    ...
    public JedisCluster(final Set<HostAndPort> nodes, final int timeout) {
        this(nodes, timeout, 5);
    }
    
    public JedisCluster(final Set<HostAndPort> nodes) {
        this(nodes, 1);
    }
    
    public JedisCluster(final Set<HostAndPort> nodes, final int timeout, final int maxRedirections) {
        this(nodes, timeout, maxRedirections, new GenericObjectPoolConfig());
    }
    
    public JedisCluster(final Set<HostAndPort> nodes, final GenericObjectPoolConfig poolConfig) {
        this(nodes, 1, 5, poolConfig);
    }
    
    public JedisCluster(final Set<HostAndPort> nodes, final int timeout, final GenericObjectPoolConfig poolConfig) {
        this(nodes, timeout, 5, poolConfig);
    }
    
    public JedisCluster(final Set<HostAndPort> jedisClusterNode, final int timeout, final int maxRedirections, final GenericObjectPoolConfig poolConfig) {
        super();
    ...
    public void close() {
        if (this.connectionHandler != null) {
            for (final JedisPool pool : this.connectionHandler.getNodes().values()) {
                try {
                    if (pool == null) {
                        continue;
                    }
    ...
    public String set(final String key, final String value) {
        return new JedisClusterCommand<String>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
    ...
    public Boolean exists(final String key) {
        return new JedisClusterCommand<Boolean>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public Boolean execute(final Jedis connection) {
    ...
    public Long persist(final String key) {
        return new JedisClusterCommand<Long>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
    ...
    public List<String> hmget(final String key, final String... fields) {
        return new JedisClusterCommand<List<String>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public List<String> execute(final Jedis connection) {
    ...
    public Set<String> hkeys(final String key) {
        return new JedisClusterCommand<Set<String>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public Set<String> execute(final Jedis connection) {
    ...
    public Map<String, String> hgetAll(final String key) {
        return new JedisClusterCommand<Map<String, String>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public Map<String, String> execute(final Jedis connection) {
    ...
    public Double zincrby(final String key, final double score, final String member) {
        return new JedisClusterCommand<Double>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public Double execute(final Jedis connection) {
    ...
    public Set<Tuple> zrangeWithScores(final String key, final long start, final long end) {
        return new JedisClusterCommand<Set<Tuple>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public Set<Tuple> execute(final Jedis connection) {
    ...
    public ScanResult<Map.Entry<String, String>> hscan(final String key, final int cursor) {
        return new JedisClusterCommand<ScanResult<Map.Entry<String, String>>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public ScanResult<Map.Entry<String, String>> execute(final Jedis connection) {
    ...
    public ScanResult<String> sscan(final String key, final int cursor) {
        return new JedisClusterCommand<ScanResult<String>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public ScanResult<String> execute(final Jedis connection) {
    ...
    public ScanResult<Tuple> zscan(final String key, final int cursor) {
        return new JedisClusterCommand<ScanResult<Tuple>>(this.connectionHandler, this.timeout, this.maxRedirections) {
            @Override
            public ScanResult<Tuple> execute(final Jedis connection) {
    ...
    public List<String> blpop(final int timeout, final String key) {
        return new JedisClusterCommand<List<String>>(this.connectionHandler, timeout, this.maxRedirections) {
            @Override
            public List<String> execute(final Jedis connection) {
