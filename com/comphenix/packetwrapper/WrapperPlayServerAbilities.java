...
public class WrapperPlayServerAbilities extends AbstractPacket
{
    ...
    public WrapperPlayServerAbilities() {
        super(new PacketContainer(WrapperPlayServerAbilities.TYPE), WrapperPlayServerAbilities.TYPE);
        this.handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerAbilities(final PacketContainer packet) {
        super(packet, WrapperPlayServerAbilities.TYPE);
    }
    ...
    static {
        TYPE = PacketType.Play.Server.ABILITIES;
    }
}
